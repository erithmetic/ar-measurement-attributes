...
describe ARMeasurementAttributes do
  ...
  it 'should display measurements in imperial units' do
    ...
    automobile.pretty_weekly_distance_estimate.should == "10mi"
    automobile.pretty_weekly_cost_estimate.should == "$45.00"

    boat.pretty_weekly_distance_estimate.should == "10.8 nautical miles"
